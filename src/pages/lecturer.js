...
import { getData, updateData } from 'src/service/Api';
      ...
      >
        <Container maxWidth="xl">
          <Stack spacing={3}>
            ...
            <CustomsSearch main={auth.userAll} setData={setData} data={data} keys={'matric'} name={"Search Lecturers"} />
            <CustomsTable
              handleOpenModal={handleOpenModal}
              items={data.filter((usr)=>usr.type==='Lecturer')}
              headers={["Staff ID", "Full name","Department"]}
               header2={["matric", "fullname","depart"]}
